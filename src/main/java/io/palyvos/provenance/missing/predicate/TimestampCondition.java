...
public class TimestampCondition implements Condition {
  ...
  /**
   * Initialize {@link TimestampCondition} between the (inclusive) boundary and {@link
   * Long#MAX_VALUE}.
   */
  ...
  /**
   * Initialize {@link TimestampCondition} between the (exclusive) boundary and {@link
   * Long#MAX_VALUE}.
   */
